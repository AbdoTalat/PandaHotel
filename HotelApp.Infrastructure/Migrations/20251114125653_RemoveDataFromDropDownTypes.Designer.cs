...
namespace HotelApp.Infrastructure.Migrations
{
    ...
    [Migration("20251114125653_RemoveDataFromDropDownTypes")]
    partial class RemoveDataFromDropDownTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.DropDownItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.DropDownType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.SystemSetting", b =>
                {
                    ...
                    b.Property<bool>("IsGuestAddressRequired")
                        .HasColumnType("bit");

                    b.Property<bool>("IsGuestDateOfBirthRequired")
                        .HasColumnType("bit");

                    b.Property<bool>("IsGuestEmailRequired")
                        .HasColumnType("bit");

                    b.Property<bool>("IsGuestPhoneRequired")
                        .HasColumnType("bit");

                    b.Property<bool>("IsGuestProofNumberRequired")
                        .HasColumnType("bit");

                    b.Property<bool>("IsGuestProofTypeRequired")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.DropDownItem", b =>
                {
                    b.HasOne("HotelApp.Domain.Entities.DropDownType", "DropDownType")
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("HotelApp.Domain.Entities.PaymentMethod", "PaymentMethod")
                        .WithMany("Payments")
                    ...
                    b.HasOne("HotelApp.Domain.Entities.DropDownItem", "TransactionType")
                        .WithMany()
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.ReservationHistory", b =>
                {
                    b.HasOne("HotelApp.Domain.Entities.User", "PerformedBy")
