...
$(function() {
    ...
    $('#EffectiveDateButton').click(function (e) {
        $('#EffectiveDateInput').AnyTime_noPicker().AnyTime_picker().focus();
        e.preventDefault();
    });

    $('#EndDateButton').click(function (e) {
        $('#EndDateInput').AnyTime_noPicker().AnyTime_picker().focus();
        e.preventDefault();
    });


    $('#CheckInDateButton').click(function (e) {
        $('#CheckInDate').AnyTime_noPicker().AnyTime_picker().focus();
        e.preventDefault();
    });

    $('#CheckOutDateButton').click(function (e) {
        $('#CheckOutDate').AnyTime_noPicker().AnyTime_picker().focus();
        e.preventDefault();
    });
