...
namespace HotelApp.Infrastructure.Migrations
{
    ...
    [Migration("20250707151901_AddStatusColumnsToReservation")]
    partial class AddStatusColumnsToReservation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.RoleBased.Entity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.RoleBased.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.RoleBased.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.RoleBased.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.RoleBased.Permission", b =>
                {
                    b.HasOne("HotelApp.Domain.Entities.RoleBased.Entity", "Entity")
            ...
            modelBuilder.Entity("HotelApp.Domain.Entities.RoleBased.RolePermission", b =>
                {
                    b.HasOne("HotelApp.Domain.Entities.RoleBased.Permission", "Permission")
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HotelApp.Domain.Entities.RoleBased.Role", "ApplicationRole")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("HotelApp.Domain.Entities.RoleBased.Role", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
